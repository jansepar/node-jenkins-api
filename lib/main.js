...
var init = exports.init = function (host, options, token) {
  ...
  var build_url = function build_url(command) {
   ...
   */
  var tryParseJson = function tryParseJson(body, property, callback) {
    var _doArgs = doArgs(arguments, ['string', 'string|array|function', 'function']);
   ...
   */
  var doRequest = function doRequest(options, customParams, callback) {
    // Default values
   ...
   */
  var doArgs = function doArgs(values, types) {
    var value,
        type,
        carry,
        optional,
