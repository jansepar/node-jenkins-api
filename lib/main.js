...
var ARTIFACT = '/job/%s/%s/artifact/%s';
...
exports.init = function (host, defaultOptions, defaultParams) {
  ...
  return {
     ...
     * @param {function} callback
     */
    get_artifact: function get_artifact(jobName, buildNumber, relativePath, customParams, callback) {
      var _doArgs77 = doArgs(arguments, ['string', 'string|number', 'string', ['object', {}], 'function']);

      var _doArgs78 = _slicedToArray(_doArgs77, 5);

      jobName = _doArgs78[0];
      buildNumber = _doArgs78[1];
      relativePath = _doArgs78[2];
      customParams = _doArgs78[3];
      callback = _doArgs78[4];
