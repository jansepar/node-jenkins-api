...
var NEW_VIEW = '/createView';
var CONFIG_VIEW = '/view/%s/configSubmit';
var DELETE_VIEW = '/view/%s/doDelete';
...
var DELETE = '/job/%s/doDelete';
var DISABLE = '/job/%s/disable';
var ENABLE = '/job/%s/enable';
...
var init = exports.init = function(host, options, token) {
     ...
     */
    var doIt = function(options, customParams, callback) {
        // Default values
