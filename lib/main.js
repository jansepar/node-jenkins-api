...
var init = exports.init = function(host, options) {
    ...
    return {
        ...
        view_info: function(viewname, callback) {
            /*
            Get all information for a view
            */
            request({method: 'GET', url: build_url(VIEWINFO, viewname)}, function(error, response, body) {
                if ( error || response.statusCode !== 200 ) {
                    callback(error || true, response);
                    return;
                }
